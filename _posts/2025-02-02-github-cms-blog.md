...
{% cloudinary /assets/img/github-cms.png alt="GitHub CMS" %}{:class="dark:brightness-75"}
...
{% cloudinary /assets/img/github-pull-request.png alt="GitHub Pull Request" %}{:class="dark:brightness-75"}
